    ...
    if transaction_date.year != current_date.year:
        ...
        if transaction_date.day < 14:
            ...
            if transaction_date.month == 12:
                due_date = datetime(transaction_date.year + 1, 1, 1)
            else:
                due_date = datetime(transaction_date.year, transaction_date.month + 1, 1)
        else:
            ...
            if transaction_date.month == 11:
                ...
                due_date = datetime(transaction_date.year + 1, 2, 1)
            else:
                due_date = datetime(transaction_date.year, transaction_date.month + 2, 1)
